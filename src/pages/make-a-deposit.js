...
const MakeADeposit = () => {
  ...
  function renderPaymentButton() {
    if (blockedEmailDetails) {
      ...
      return (
        <>
          <a href={stripeUrl} className="learn-more-btn cash" target="_blank" rel="noopener noreferrer">Deposit cash</a>
  ...
  return (
    <div>
      ...
      <div className="content-container">
        ...
        <sub>Pay a small, refundable deposit to get your email to my main inbox & get my immediate attention. If I respond, you get your deposit back.
          Simple!</sub>
