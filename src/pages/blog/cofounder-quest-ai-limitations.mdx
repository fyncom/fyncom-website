...
import readingDocs from "../../images/blog/cofounders-paradise.jpg"
import foundBug from "../../images/blog/aigauntlet-1.jpg"
import lastPic from "../../images/blog/multiplatform-coming-together.jpg"
...
{" "}
<img className="float-left larger" src={readingDocs} alt="Frustration with debugging" />
...
## The AI Gauntlet: Every Model Failed
  ...
  {" "}
<img className="float-left large" src={foundBug} alt="multiple blue hologram / robots focused on a cilndrical power source" />
<div className="list-container" style={{ overflow: 'hidden' }}>
- **GPT-4o1** - [Link to conversation](../gpt4o1-conversation)  (Shout out to [Professor Russ McBride](https://engineering.ucmerced.edu/content/russ-mcbride) for running this prompt with his pro plan!)
...
{" "}
<img src={lastPic} alt="Complexity of multiplatform pathways" />
...
{" "}
export const KarmaCallCTA = () => {
  const [showModal, setShowModal] = useState(false);
  return (
    <div className="download-app-cta">
      <p>Oh, and if you're curious to try out the "cash back for spam" app we built - <button onClick={() => setShowModal(true)} className="text-link-button">check it out here</button></p>
