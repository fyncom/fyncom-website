...
The FynCom Filter was first demonstrated in our [KarmaCall mobile application](https://karmacall.com/), where we gave over [100,000 instant payments](https://nanexplorer.com/nano/accounts/nano_3rcpayu3g39njpq3mkizuepfr5rh1nwuz4xypwsmubkoiww88wubff8d719t) to people for blocking phone scam calls. Immediately after we blocked a scam call, the call recipient (the KarmaCall user) would receive a financial payment.
