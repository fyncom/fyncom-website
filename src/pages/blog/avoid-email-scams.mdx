...
description: "Get cash back for blocking spam emails! Discover how you can stop email scams with FynCom's innovative whitelist tool + get rewarded for every scam email blocked. It's time to declutter your inbox and get paid for it!"
};
...
<Wrapper seo={meta}>
  ...
  <div className="button-container">
    <Link className="learn-more-btn cash centered" to="/fyncom-filters-email-edition">Click here to buy!</Link>
  </div> <br/>
