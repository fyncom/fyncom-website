...
description: "Discover how you can turn the tide on email spam with FynCom's innovative filter technology and tap into instant rewards for every scam email blocked. It's time to declutter your inbox and get paid for it!"
date: "2023-11-14"
...
<Wrapper seo={meta}>
  ...
  <div className="use-case-section">
    ...
    <div className="use-case-description">
      To us, it doesn't really matter. It's either powered by FynCom (**which adds real cash to the interaction**) or it's not. Based on recent trends, we are considering bringing our[patented "FynCom Filter" technology](https://patents.google.com/patent/US11310368B2) to emails - **allowing you to get instantly paid for every spam email you allow us to block**. First, we need you to vote with your wallets or your signups.
    </div>
  </div>
  ...
  6. I **f No.** FynCom checks if this sender has a FynCom account with more than $0.01 worth of funds.
  ...
  10. I **f No.** The email gets tagged and moved into a separate folder called "FynCom Filter". It won't be in your main inbox.
  ...
  2. The future is headed towards a society that will require some form of "REFUNDABLE financial deposit" in order to email / call / text / DM / cold contact someone. We predicted this years ago with our first [white paper](https://karmacall.com/KarmaCallWhitePaper.pdf), and have staked our entire business model around being that financial lubricant that will sustain this ecosystem.
  ...
  <Link to="/fyncom-filters-email-edition">Click here to buy </Link>
