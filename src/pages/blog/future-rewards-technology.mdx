...
export const meta = {
  title: "Revolutionizing Engagement: The Rise of Interactive Rewards Technology",
  description: "Unveil the transformative impact of interactive rewards in sales and marketing. Learn how automation and personalization in rewards programs are setting new standards for customer interaction and loyalty."
};
...
<Wrapper seo={meta}>
  ...
  <div className="button-container">
    <a className="learn-more-btn cash centered" href="https://calendly.com/adrian-fyncom/30min">    Schedule your meeting right now, and get your instant reward!</a>
  </div> <br/>
