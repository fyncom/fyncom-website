...
[//]: # (causes issues)
[//]: # (<img className={"float-left large"} src={linkedInSurvey} alt="Product marketers want responses!" />)
[//]: # (      <img className={"float-left"} src={linkedInSurvey} alt="Product marketers want responses!" />)
