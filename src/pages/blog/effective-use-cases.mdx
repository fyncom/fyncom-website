...
2. Go to the{" "}[FynCom portal](https://app.fyncom.com/settings) and {" "}<Link to="/user-help-center/crowdin-rewards-for-translations-user-setup">input your Crowdin username</Link>.
