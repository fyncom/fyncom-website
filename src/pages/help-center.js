...
const HelpCenter = () => {
  ...
  const helpItems = [
    ...
    { title: "Sendgrid Email Rewards", description: "Attach Rewards To Emails", icon: "mail-bulk", url: "https://raw.githubusercontent.com/fyncom/fyncom-help/main/Attaching-FynCom-Rewards-To-Sendgrid-Emails.md" },
        ...
        <div className="help-items">
          {helpItems.map(item => (
            <div key={item.title}
                 ...
                 data-has-url={!!item.url}> {/* This will add the attribute if the item has a URL */}
