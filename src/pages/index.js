      ...
      <section>
            ...
            <div className="logo-container">
              <div className="top-logos-left">
                <Link to="/fyncom-filters-email-edition" className="index-links">
                  <GatsbyImage image={filterLogo} alt="block bad emails automatically & get paid." sizes="(min-width: 768px) 200px, 90px" />
                </Link>
                <a href="https://www.karmacall.com" className="index-links">
                  <GatsbyImage image={karmacallLogo} alt="Get paid to block scam calls!" sizes="(min-width: 768px) 200px, 90px" />
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="social-media-container communities">
            <div className="logo-container">
              <div className="top-logos communities">
                <GatsbyImage image={discordLogo} alt="Discord" sizes="(min-width: 768px) 140px, 90px" />
                <GatsbyImage image={telegramLogo} alt="Telegram" sizes="(min-width: 768px) 140px, 90px" />
              </div>
              <div className="bottom-logo community">
                <GatsbyImage image={tinderLogo} alt="Tinder" sizes="(min-width: 768px) 320px, 90vw" />
              </div>
            </div>
            <div className="text-block">
              <h2 className="text-wrapper-2">
        ...
        <section className="why-fyncom">
          ...
          <p>
            ...
            <Link to="/white-paper-original-scam-calls">Read the scam calls white paper</Link>
          </p>
        </section>
        ...
        <div className="AppText">
          <div className="social-media-container">
            <div className="text-block-left">
              ...
              <p>
                <span className="underline-red">...and a rewards engine for all.</span>{" "}
                FynCom creates trust in online communications with its Refundable Deposits API. Any platform with communication between users can give cash-back
                to users for blocking scams. Bring a modern approach to cybersecurity that your customers will love & your revenue teams will love more.
              </p>
            </div>
            <div className="logo-container">
              <div className="bottom-logo">
