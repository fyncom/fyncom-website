  ...
  return (
    <div>
      ...
      <div className="content-container">
        ...
        <p>That's the thought that started me on a journey of exploring an emerging market that blends communications & currency to create trust between
          strangers with shared interests. Here's the paper I wrote to record my thoughts - it later became{" "}
          <a href="https://patents.google.com/patent/US11310368B2">my 1st patent</a>,{" "}
          <a href="https://www.karmacall.com/">app</a>,{" "} and is the basis for how FynCom came to be.
        ...
        <p>
          ...
          starting with scam calls! <Link to={"/"}>Try out the  apps today </Link>to get started!
        </p>
      </div>
      <Footer />
    </div>
