  ...
  return (
    <div>
      ...
      <main className="contact-container">
        ...
        <div className="contact-additional-content">
          <h2>What is FynCom?</h2>
          <p>FynCom helps you stop spam and scams, while making money for yourself or your organization.</p>
          <p>
            We build "money layers" on top of communications platforms / protocols & enforce escrow between unknown parties while rewarding people who block
            spam, respond to messages, or engage with the sales funnels of your organization .
          </p>
          ...
          <div className="info-section">
            <p>
              Save time & let us pay you to ignore those scam emails & calls! Be the first to know when our text / SMS blocking tech is ready by signing up to
              one of our apps today!
            </p>
