      ...
      <section className="story-section">
        ...
        <div className="story-text">
          ...
          <p>
            ...
            (<Link to="/white-paper-original-scam-calls">Read more here</Link>). As we spoke to businesses about our solution, we learned that getting
            responses to business communications is tough!
          </p>
          <p>
          ...
          <p>
            ...
            response to communications, so <p2 className="p2-blue">Fyn</p2><p2 className="text-wrapper-3-red">Com</p2> is short for
            "<p2 className="p2-blue">Fin</p2>ancial <p2 className="text-wrapper-3-red">Com</p2>munications".
          </p>
        </div>
      </section>
