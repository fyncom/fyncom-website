    ...
    <div>
      ...
      <section className="story-section">
        ...
        <div className="story-text">
          <h3>Our Story</h3>
          <p>
            FynCom's Rewards technology was invented to disrupt scam economics over phone calls with refundable cash deposits (<Link to="/white-paper-original-scam-calls">Read more here</Link>). As we spoke to businesses about our solution, we learned that getting responses to business communications is tough!
          </p>
          <p>
